...
import { FlatList, Image, Linking, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, Dimensions, Alert, Share } from "react-native";
import { ACCOUNT, LIKE, LOGO2, PRESSLIKE, SHARE, THREEDOTS, WHATSAPP, VIEW } from "../../constants/imagePath";
...
export default SportsNews = ({ route, navigation }) => {
    const { newsData } = route.params;
    console.log('Received newsData in SportsNews:', newsData);
    console.log('Featured Image URL:', newsData?.featured_image ? `${BASE_URL}${newsData.featured_image}` : null);
    console.log('VideoPath in SportsNews:', newsData?.videoPath);
                        ...
                        <View style={styles.imageContainer}>
                            <Image 
                                ...
                                onError={(e) => {
                                    ...
                                    console.log('Failed image URI:', fullImageUrl);
